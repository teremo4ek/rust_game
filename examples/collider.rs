...
//!
//!     cargo install rust_game --example collider
//!
...
//!
//! Of course, you could also clone the rust_game repository, place your image
...
fn main() {
    ...
    // makes using it from `cargo install rust_game --example collider` possible.
