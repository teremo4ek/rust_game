...
impl<S: Resource + Send + Sync + 'static> Game<S> {
    ...
    /// [window](https://github.com/CleanCut/rust_game/blob/main/examples/window.rs) example for
    /// more information.
