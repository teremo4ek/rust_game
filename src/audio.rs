...
/// `sfx` example by cloning the `rust_game` repository and running the following command:
///
/// ```text
...
/// by cloning the `rust_game` repository and running the following command:
///
/// ```text
