...
//! # Quick Start Example
//!
//! You start by importing `rust_game::prelude::*`, define your own `GameState` struct,
...
//! [this `README.md` file](https://github.com/CleanCut/rust_game/tree/main/assets/audio/music)
